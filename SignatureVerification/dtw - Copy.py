...
def detection(user,signature):
        ...
        #username.upper()
        #username = user
        signatureDB = open(f"/home/bhavesh/DMML/Task2/U{user}S{signature}.TXT","r")
        ...
        for i in range(1,6):
            #username2 = f"U1S{i}"
            signatureDB2 = open(f"/home/bhavesh/DMML/Task2/U{user}S{i}.TXT","r")
...
for i in range(1,41):
    for j in range(1,41):
#        if((j>=0 and j<=21) and detection(i,j)==1):
#            P = P+1
#            print("P=",P)
#        elif((j>=21 and j<=41) and detection(i,j)==0):
#            P = P+1
#            print("P=",P)
#        else:
#            F = F+1
